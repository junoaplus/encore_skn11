...
with open('/Users/hwangjunho/Desktop/encore_skn11/web_crawling/html_sample.html', 'r', encoding='utf-8') as f:
    html = f.read()
...
def test_find():
    ...
    # find_all : html 태크 및 속서을 dict로 조회 (전부 다 조회)
...
def get_content():
    # id가 section2인 section 태그의 자손 ㅣi 태그들을 추출
    # 자식 요소 : section#section2 > h2
    # 후손 요소 : section#section2 li
    tags = bs.select('section#section2')
